...
class EditorShell : public QMainWindow
{
public:
    EditorShell();
...
private:
    ...
    QString activePanelDisplayName(ActivePanel panel) const;
    ...
    QWidget* createGraphEditorPanel();
    ...
    GraphEditorViewModel buildGraphEditorViewModel() const;
    ...
    void setSelectedFrameRange(int startFrame, int endFrame);
    ...
    void updateCommandLineDisplay();
    void setCommandLineBaseStatus(const QString& text, const QString& tone);
    ...
    RangeSliderPanel* rangeSliderPanel_ = nullptr;
    GraphEditorPanel* graphEditorPanel_ = nullptr;
    QLabel* commandLineStatusLabel_ = nullptr;
    ...
    ActivePanel activePanel_ = ActivePanel::Viewport;
